...
//                arrayListOf(2, 3, 4) -> chosenId = 9
            ...
            if (countNotNullElement >=4) {
                if (chosenId != 0) {
                    val detailBabyBroiler = Intent(this, DetailBabyBroilerActivity::class.java).apply {
                        putExtra("CHOSENID", chosenId)
                    }
                    startActivity(detailBabyBroiler)
                }
            } else {
